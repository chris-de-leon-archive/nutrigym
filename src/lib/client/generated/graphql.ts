...
export type BodyQuery = { __typename?: 'Query', body?: { __typename?: 'Body', id: string, userId: string, birthday: Date, gender: string } | null };
...
export type CreateBodyMeasurementMutation = { __typename?: 'Mutation', createBodyMeasurement: { __typename?: 'GenericID', id: string } };
...
export type BodyMeasurementByDateQuery = { __typename?: 'Query', bodyMeasurementByDate?: { __typename?: 'BodyMeasurement', id: string, createdAt: Date, logId: string, weightInPounds: number, heightInInches: number, waterInMilliliters?: number | null, shouldersInInches?: number | null, forearmsInInches?: number | null, calvesInInches?: number | null, thighsInInches?: number | null, waistInInches?: number | null, chestInInches?: number | null, armsInInches?: number | null, neckInInches?: number | null, hipsInInches?: number | null, sleepInHours?: number | null, steps?: number | null } | null };
...
export type RemoveBodyMeasurementsMutation = { __typename?: 'Mutation', removeBodyMeasurements: { __typename?: 'Count', count: number } };
...
export type UpdateBodyMeasurementMutation = { __typename?: 'Mutation', updateBodyMeasurement: { __typename?: 'Count', count: number } };
...
export type RemoveFoodMeasurementsMutation = { __typename?: 'Mutation', removeFoodMeasurements: { __typename?: 'Count', count: number } };
...
export const CreateBodyMeasurementDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateBodyMeasurement"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateBodyMeasurementInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createBodyMeasurement"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<CreateBodyMeasurementMutation, CreateBodyMeasurementMutationVariables>;
...
export const RemoveBodyMeasurementsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveBodyMeasurements"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"ids"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Uuid"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"removeBodyMeasurements"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"ids"},"value":{"kind":"Variable","name":{"kind":"Name","value":"ids"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"count"}}]}}]}}]} as unknown as DocumentNode<RemoveBodyMeasurementsMutation, RemoveBodyMeasurementsMutationVariables>;
