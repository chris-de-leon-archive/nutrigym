...
export type FoodsQuery = {
  ...
  foods: Array<{
    ...
    servingSize: number
    servingUnit: string
    totalProteinInGrams?: number | null
    totalCarbsInGrams?: number | null
    totalFatInGrams?: number | null
    polyunsaturatedFatInGrams?: number | null
    monounsaturatedFatInGrams?: number | null
    saturatedFatInGrams?: number | null
    potassiumInMilligrams?: number | null
    sodiumInMilligrams?: number | null
    dietaryFiberInGrams?: number | null
    sugarsInGrams?: number | null
    cholesterolInMilligrams?: number | null
    calciumInMilligrams?: number | null
    ironInMilligrams?: number | null
  }>
}
...
export type CreateGoalMutation = {
  __typename?: "Mutation"
  createGoal: { __typename?: "Count"; count: number }
}
...
export type UpsertBodyMeasurementMutation = {
  __typename?: "Mutation"
  upsertBodyMeasurement: { __typename?: "Count"; count: number }
}
...
export type RemoveMeasurementsMutation = {
  __typename?: "Mutation"
  removeMeasurements: { __typename?: "Count"; count: number }
}
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "servingUnit" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "totalProteinInGrams" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "totalCarbsInGrams" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "totalFatInGrams" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "polyunsaturatedFatInGrams" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "monounsaturatedFatInGrams" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "saturatedFatInGrams" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "potassiumInMilligrams" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "sodiumInMilligrams" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "dietaryFiberInGrams" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "sugarsInGrams" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "cholesterolInMilligrams" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "calciumInMilligrams" },
                },
                {
                  kind: "Field",
...
} as unknown as DocumentNode<FoodsQuery, FoodsQueryVariables>
...
export const GoalByLatestDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GoalByLatest" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<GoalByLatestQuery, GoalByLatestQueryVariables>
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "bodyMeasurement" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "id" } },
...
>
export const UpsertBodyMeasurementDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpsertBodyMeasurement" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "date" } },
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "UpsertBodyMeasurementInput" },
            },
          },
        },
      ],
  ...
  UpsertBodyMeasurementMutation,
  UpsertBodyMeasurementMutationVariables
>
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "foodMeasurements" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "id" } },
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "servingSize" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "servingUnit" },
                            },
                            {
                              kind: "Field",
                              name: {
                                kind: "Name",
                                value: "totalProteinInGrams",
                              },
                            },
                            {
                              kind: "Field",
                            ...
                            },
                            {
                              ...
                              name: {
                                kind: "Name",
                                value: "polyunsaturatedFatInGrams",
                              },
                            },
                            {
                              kind: "Field",
                              name: {
                                kind: "Name",
                                value: "monounsaturatedFatInGrams",
                              },
                            },
                            {
                              kind: "Field",
...
export const RemoveMeasurementsDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "RemoveMeasurements" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "RemoveMeasurementsInput" },
            },
          },
        },
      ],
  ...
  RemoveMeasurementsMutation,
  RemoveMeasurementsMutationVariables
>
