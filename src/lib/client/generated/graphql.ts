...
export type BodyQuery = { __typename?: 'Query', body?: { __typename?: 'Body', id: string, userId: string, birthday: string, gender: Gender } | null };
...
export type CreateGoalMutation = { __typename?: 'Mutation', createGoal: { __typename?: 'Count', count: number } };
...
export type GoalByDateQuery = { __typename?: 'Query', goalByDate?: { __typename?: 'Goal', id: string, createdAt: string, latest: boolean, version: string, waterInMilliliters: number, weightInPounds: number, sleepInHours: number, proteinPercentage: number, carbsPercentage: number, fatPercentage: number, calories: number, steps: number } | null };
...
export type GoalByIdQuery = { __typename?: 'Query', goalByID?: { __typename?: 'Goal', id: string, createdAt: string, latest: boolean, version: string, waterInMilliliters: number, weightInPounds: number, sleepInHours: number, proteinPercentage: number, carbsPercentage: number, fatPercentage: number, calories: number, steps: number } | null };

export type GoalByLatestQueryVariables = Exact<{ [key: string]: never; }>;


export type GoalByLatestQuery = { __typename?: 'Query', goalByLatest?: { __typename?: 'Goal', id: string, createdAt: string, latest: boolean, version: string, waterInMilliliters: number, weightInPounds: number, sleepInHours: number, proteinPercentage: number, carbsPercentage: number, fatPercentage: number, calories: number, steps: number } | null };
