...
export type BodyQuery = { __typename?: 'Query', bodyByID?: { __typename?: 'Body', id: string, userId: string, birthday: any, gender: string } | null };
