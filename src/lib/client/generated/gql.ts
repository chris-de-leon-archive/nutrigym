...
export function graphql(
  source: "mutation CreateBody($data: CreateBodyInput!) {\n  createBody(data: $data) {\n    id\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation UpdateBody($id: Uuid!, $data: UpdateBodyInput!) {\n  updateBody(id: $id, data: $data) {\n    count\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation CreateGoal($data: CreateGoalInput!) {\n  createGoal(data: $data) {\n    count\n  }\n}",
): (typeof documents)["mutation CreateGoal($data: CreateGoalInput!) {\n  createGoal(data: $data) {\n    count\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query GoalByDate($date: Date!) {\n  goalByDate(date: $date) {\n    id\n    createdAt\n    latest\n    version\n    waterInMilliliters\n    weightInPounds\n    sleepInHours\n    proteinPercentage\n    carbsPercentage\n    fatPercentage\n    calories\n    steps\n  }\n}",
): (typeof documents)["query GoalByDate($date: Date!) {\n  goalByDate(date: $date) {\n    id\n    createdAt\n    latest\n    version\n    waterInMilliliters\n    weightInPounds\n    sleepInHours\n    proteinPercentage\n    carbsPercentage\n    fatPercentage\n    calories\n    steps\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query GoalByID($id: Uuid!) {\n  goalByID(id: $id) {\n    id\n    createdAt\n    latest\n    version\n    waterInMilliliters\n    weightInPounds\n    sleepInHours\n    proteinPercentage\n    carbsPercentage\n    fatPercentage\n    calories\n    steps\n  }\n}",
): (typeof documents)["query GoalByID($id: Uuid!) {\n  goalByID(id: $id) {\n    id\n    createdAt\n    latest\n    version\n    waterInMilliliters\n    weightInPounds\n    sleepInHours\n    proteinPercentage\n    carbsPercentage\n    fatPercentage\n    calories\n    steps\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query GoalByLatest {\n  goalByLatest {\n    id\n    createdAt\n    latest\n    version\n    waterInMilliliters\n    weightInPounds\n    sleepInHours\n    proteinPercentage\n    carbsPercentage\n    fatPercentage\n    calories\n    steps\n  }\n}",
): (typeof documents)["query GoalByLatest {\n  goalByLatest {\n    id\n    createdAt\n    latest\n    version\n    waterInMilliliters\n    weightInPounds\n    sleepInHours\n    proteinPercentage\n    carbsPercentage\n    fatPercentage\n    calories\n    steps\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query BodyMeasurementByDate($date: Date!) {\n  measurementsByDate(date: $date) {\n    id\n    createdAt\n    goalId\n    userId\n    month\n    year\n    day\n    bodyMeasurement {\n      id\n      createdAt\n      logId\n      weightInPounds\n      heightInInches\n      waterInMilliliters\n      shouldersInInches\n      forearmsInInches\n      calvesInInches\n      thighsInInches\n      waistInInches\n      chestInInches\n      armsInInches\n      neckInInches\n      hipsInInches\n      sleepInHours\n      steps\n    }\n  }\n}",
): (typeof documents)["query BodyMeasurementByDate($date: Date!) {\n  measurementsByDate(date: $date) {\n    id\n    createdAt\n    goalId\n    userId\n    month\n    year\n    day\n    bodyMeasurement {\n      id\n      createdAt\n      logId\n      weightInPounds\n      heightInInches\n      waterInMilliliters\n      shouldersInInches\n      forearmsInInches\n      calvesInInches\n      thighsInInches\n      waistInInches\n      chestInInches\n      armsInInches\n      neckInInches\n      hipsInInches\n      sleepInHours\n      steps\n    }\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation UpsertBodyMeasurement($date: Date!, $data: UpsertBodyMeasurementInput!) {\n  upsertBodyMeasurement(date: $date, data: $data) {\n    count\n  }\n}",
): (typeof documents)["mutation UpsertBodyMeasurement($date: Date!, $data: UpsertBodyMeasurementInput!) {\n  upsertBodyMeasurement(date: $date, data: $data) {\n    count\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation CreateFoodMeasurementFromFoodDetails($date: Date!, $data: CreateFoodMeasurementFromFoodDetailsInput!) {\n  createFoodMeasurementFromFoodDetails(date: $date, data: $data) {\n    id\n  }\n}",
): (typeof documents)["mutation CreateFoodMeasurementFromFoodDetails($date: Date!, $data: CreateFoodMeasurementFromFoodDetailsInput!) {\n  createFoodMeasurementFromFoodDetails(date: $date, data: $data) {\n    id\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation CreateFoodMeasurementFromFoodID($date: Date!, $data: CreateFoodMeasurementFromFoodIdInput!) {\n  createFoodMeasurementFromFoodID(date: $date, data: $data) {\n    id\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation UpdateFoodMeasurement($id: Uuid!, $date: Date!, $data: UpdateFoodMeasurementInput!) {\n  updateFoodMeasurement(id: $id, date: $date, data: $data) {\n    count\n  }\n}",
): (typeof documents)["mutation UpdateFoodMeasurement($id: Uuid!, $date: Date!, $data: UpdateFoodMeasurementInput!) {\n  updateFoodMeasurement(id: $id, date: $date, data: $data) {\n    count\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation RemoveMeasurements($id: Uuid!, $data: RemoveMeasurementsInput!) {\n  removeMeasurements(id: $id, data: $data) {\n    count\n  }\n}",
